  ...
  function keyAction(key, repeat) {
    ...
    if (key === 'x' && !repeat) {
      ...
      cref.current.toBlob(function (blob) {
        link.setAttribute('download', "flow-".concat(new Date().toISOString().slice(0, -4).replace(/-/g, '').replace(/:/g, '').replace(/_/g, '').replace(/\./g, ''), ".png"));
...
//# sourceMappingURL=index.js.8fcdeee05d3234d8510b.hot-update.js.map