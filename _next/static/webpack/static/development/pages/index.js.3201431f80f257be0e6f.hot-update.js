...
var Home = function Home() {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, KeyTip('2', color), " adjust cursor\xA0 ", KeyTip('space', color), ' ', "pause/play flows\xA0 ", KeyTip('space', color), "\xA0", ' ', KeyTip('v', color), " show flow outlines")) : mode === 'choose_flow' ? __jsx("div", {
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default.a.dynamic([["632941774", [fs, lh]]]),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 527
...
//# sourceMappingURL=index.js.3201431f80f257be0e6f.hot-update.js.map